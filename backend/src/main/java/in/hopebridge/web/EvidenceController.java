...
public class EvidenceController {
    ...
    @PostMapping("/cases/{caseId}/evidence") ResponseEntity<?> upload(@PathVariable Long caseId,@RequestParam("file") MultipartFile file,Authentication a) throws Exception {
